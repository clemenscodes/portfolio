...
export const Skills: React.FC<SkillsProps> = ({ skillsProp = skillsSection, ...props }) => {
    ...
    return (
        <section {...props} className={cn(['flex flex-col xl:mt-20 xl:flex-row'])} id='skills'>
            <div
                className={cn(
            ...
            >
                ...
                {skillsProp.skillCategories.map((category, index) => (
                    ...
                    >
                        <h2
                            className={cn(
                                'pt-8 text-center text-xl font-semibold text-dimmed-muted dark:text-dimmed-font xl:text-2xl'
                            )}
                        >
